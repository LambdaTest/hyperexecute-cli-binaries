# HyperExecute CLI for TestMu AI (Formerly LambdaTest)
...
Contributions are welcome. Open an issue to discuss your idea before submitting a pull request. When reporting bugs, include your OS, CLI binary version, and YAML config.
